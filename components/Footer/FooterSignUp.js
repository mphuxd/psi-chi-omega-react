...
const FooterSignUp = ({ youtube, ig, facebook, text }) => {
  return (
    <div className='px-2 mt-20 col-span-full flex flex-col items-center sm:block sm:max-w-none sm:col-span-5 sm:order-4 md:mt-0 md:col-span-5 md:order-2 xl:col-span-4 xl:col-start-9'>
